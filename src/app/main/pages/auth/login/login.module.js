(function ()
{
    ...
    function config($stateProvider, $translatePartialLoaderProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider.state('app.user_email_confirmation', {
            url      : '/auth_users/confirmation/:confirmation_token',
            views    : {
                'main@'                       : {
                    templateUrl: 'app/core/layouts/content-only.html',
                    controller : 'MainController as vm'
                },
                'content@app.user_email_confirmation': {
                    templateUrl: 'app/main/pages/auth/login/login.html',
                    controller : 'EmailConfirmationController as vm'
                }
            },
            loginRequired : false,
            bodyClass: 'login'
