(function ()
{
    'use strict';
    angular
        .module('app.warehouse-management').directive('tagInput', function() {
    return {
      restrict: 'E',
      scope: {
        inputTags: '=taglist',
...
.directive('disabledTagInput', function() {
    return {
      restrict: 'E',
      scope: {
        inputTags: '=taglist',
...
window.CP.exitedLoop(1);
      ...
      template: "<div class='tag-input-ctn'><div class='input-tag' data-ng-repeat=\"tag in tagArray()\">{{tag}}</div></div>"
    };
  });
